<template>
  <div
    class="vlb-element"
    :class="{ 'vlb-element--loading': navDelayed || loading }"
    @click="close"
  >
    ...
    <div class="vlb-wrapper-outer">
      <div class="vlb-wrapper-inner">
        ...
        >
          <div
            class="vlb-close-wrapper"
            v-if="!loading && !navDelayed"
          >
            <slot
              name="close"
          ...
          <figure class="vlb-figure">
            <div
              class="vlb-loading"
              v-if="navDelayed || loading"
            >
              <slot name="loading">{{loadingCaption}}</slot>
            </div>
            <div
              v-if="!navDelayed && currentItem && !_isVideo(currentItemUrl)"
              v-show="!loading"
              class="vlb-image-wrapper"
            >
              <img
                class="vlb-image"
                :src="currentItemUrl"
            ...
            <div
              v-if="!navDelayed && currentItem && _isVideo(currentItemUrl)"
              v-show="!loading"
              class="vlb-frame-wrapper"
            >
              <div class="vlb-frame-sizer">
                <iframe
                  class="vlb-frame"
                  frameborder="0"
                  allowfullscreen
            ...
            <slot
              v-if="currentItem && !loading && !navDelayed"
              name="caption"
...
export default {
  ...
  computed: {
    ...
    currentItemUrl () {
      return typeof this.currentItem === 'string'
        ? this.currentItem
